(function($) {
	...
	function downscrollfn(){
		scrollmain.children(options.boxchild).eq(scrollmain.children(options.boxchild).length-1).hide(1000,function(){
			$(this).prependTo(scrollid).slideDown(options.speed)
